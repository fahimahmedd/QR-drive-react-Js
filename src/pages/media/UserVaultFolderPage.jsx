...
import UserVaultFolderBody from "../../components/media/userVaultFolderBody/UserVaultFolderBody";
import UserVaultLeftSideBar from "../../components/Sidebar/UserVaultLeftSideBar";

const UserVaultFolderPage = () => {
    ...
    return (
      <>
        ...
        <div className="myfile_page_body_content">
          <UserVaultFolderBody total_size={total_size} allVaultLists={allVaultLists} />
          {/* <DynamicUploader
...
export default UserVaultFolderPage;
