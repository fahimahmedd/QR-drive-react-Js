              ...
              <div className="entry_conetnt_two">
                ...
                <div className="entry_process_container">
                  <div className="process_wrapper">
                    ...
                    <Box sx={{ mt: 5 , }} onClick={(e)=> navigate('/lost-found')} >
                        <Button sx={{fontSize : "10px", color: "white", fontStyle : "italic"}} className ="cursorPointer" >Lost and Found</Button>
                    </Box>
                  </div>
