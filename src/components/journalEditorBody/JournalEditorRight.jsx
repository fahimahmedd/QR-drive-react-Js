  ...
  const handleCreateJounal = () => {
    ...
    if (inputList.length > 0) {
      for (let i = 0; i < inputList.length; i++) {
        if (inputList[i].witness !== undefined) {
  ...
  return (
    <Fragment>
                ...
                {(popupState) => (
                  <React.Fragment>
                    ...
                    <Menu {...bindMenu(popupState)}>
                      ...
                      {/* <MenuItem onClick={popupState.close}>Delete Journal </MenuItem> */}
                    </Menu>
                  </React.Fragment>
                )}
              </PopupState>
      ...
      >
        ...
        <DialogContent>
          <div className="Journal_Witness_modal">
              ...
              return (
                <div className="box" key={i}>
                  <TextField
                    ...
                    label="Enter Witness Email"
                    variant="filled"
                  />
                  <div className="witnes_btn">
...
export default JournalEditorRight;
