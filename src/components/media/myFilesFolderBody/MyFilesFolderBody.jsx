...
import DynamicUploader from "../DynamicUploader";
const MyFilesFolderBody = ({total_size, allVaultLists}) => {
        ...
        <div className="my_files_body">
          <div className="my_files_navigate">
            <div className="navigate_part_one">
              ...
              <div className="navigate_bar_icon" onClick={(e)=> navigate('/files')}>
                <DashboardIcon />
              </div>
...
export default MyFilesFolderBody;
